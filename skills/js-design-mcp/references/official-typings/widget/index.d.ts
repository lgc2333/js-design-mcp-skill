// Crawl-Date: 2026-06-18
// Package: @jsdesigndeveloper/widget-typings
// Version: 1.0.3
...
declare global {
  ...
  interface WidgetAPI {
    ...
    // Hooks
    useWidgetId(): string
    useSyncedState<T = any>(name: string, defaultValue: T | (() => T)): [T, (newValue: T | ((currValue: T) => T)) => void]
  ...
  type JsDesignDeclarativeChildren<T> = JsDesignVirtualNode<T> | JsDesignDeclarativeChildren<T>[] | string | null | undefined | false
  ...
  interface TextChildren {
    children?: JsDesignVirtualNode<'span'> | string | number | (JsDesignVirtualNode<'span'> | string | number)[]
  }
  ...
  namespace WidgetJSX {
    ...
    export type GradientPaint = GradientPaintWithPositions | GradientPaintWithTransform
    ...
    type VerticalConstraint = TopConstraint | BottomConstraint | TopBottomConstraint | CenterConstraint | VerticalScaleConstraint
    type HorizontalConstraint = LeftConstraint | RightConstraint | LeftRightConstraint | CenterConstraint | HorizontalScaleConstraint
    ...
    export type FontWeightString = 'thin' | 'extra-light' | 'light' | 'normal' | 'medium' | 'semi-bold' | 'bold' | 'extra-bold' | 'black'
    ...
    interface HoverStyle {
      fill?: HexCode | Color | SolidPaint | GradientPaint | (SolidPaint | GradientPaint)[]
    ...
    export interface FrameProps extends BaseProps, GeometryProps, Required<SizeProps>, TransformProps, CornerProps {
      overflow?: Overflow
    }

    export interface AutoLayoutProps extends Omit<FrameProps, 'width' | 'height'>, LayoutProps, AutoLayoutSizeProps {}
    ...
    export interface RectangleProps extends BaseProps, GeometryProps, Required<SizeProps>, TransformProps, CornerProps {}

    export interface SVGProps extends BaseProps, GeometryProps, SizeProps, TransformProps, PathProps {}
    ...
    export interface TextProps extends BaseProps, AutoLayoutSizeProps, TransformProps, Omit<GeometryProps, 'fill'>, TextStyleProps {
